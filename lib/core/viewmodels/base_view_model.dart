import 'package:flutterbasesource/core/base/base_model.dart';
import 'package:flutterbasesource/core/base/base_service.dart';
...
class BaseViewModel extends BaseModel with BaseService {
  ...
  callApis(dynamic data, String url, String method,
      ...
      List<http.MultipartFile> multipartFile}) async {
